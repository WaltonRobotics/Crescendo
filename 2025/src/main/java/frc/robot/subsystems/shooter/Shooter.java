...
public class Shooter extends SubsystemBase {
    ...
    private AngularVelocity m_leftTarget = RotationsPerSecond.of(0);
    private AngularVelocity m_rightTarget = RotationsPerSecond.of(0);
    private final Supplier<AngularVelocity> m_leftTargetSupp = () -> m_leftTarget;
    // unused thing was bothering me.
    // private final Supplier<AngularVelocity> m_rightTargetSupp = () ->
    // m_rightTarget;
    ...
    public Command toVelo(Supplier<AngularVelocity> velo, BooleanSupplier idle) {
        Runnable spin = () -> {
    ...
    public Command toVelo(Supplier<AngularVelocity> velo, BooleanSupplier idle, double spinAmt) {
        int slot;
    ...
    private Command toVeloNoSpin(Supplier<AngularVelocity> velo) {
