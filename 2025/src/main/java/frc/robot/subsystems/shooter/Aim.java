...
public class Aim extends SubsystemBase {
    ...
    private Angle m_targetAngle = Rotations.of(0);
    ...
    private final Angle kAngleAllowedError = Degrees.of(0.6);
    private final Angle kAmpAngleAllowedError = Degrees.of(0.75);
    ...
    public Command toAngleUntilAt(Angle angle, Angle tolerance) {
        return toAngleUntilAt(() -> angle, tolerance);
    }

    public Command toAngleUntilAt(Angle angle) {
    ...
    public Command toAngleUntilAt(Supplier<Angle> angle, Angle tolerance) {
       return toAngleUntilAt(angle, tolerance, false);
    }

    public Command toAngleUntilAt(Supplier<Angle> angle, Angle tolerance, boolean amp) {
        Runnable goThere = () -> {
    ...
    public Command setTarget(Angle target) {
        return Commands.runOnce(() -> {
