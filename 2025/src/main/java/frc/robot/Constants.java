...
public class Constants {
    ...
    public class FieldK {
        ...
        public static final class SpeakerK {
            private static final Distance kTopX = Inches.of(18.055);
            private static final Distance kTopZ = Inches.of(83.091);
            ...
            private static final Distance kBotX = Inches.of(0);
            private static final Distance kBotZ = Inches.of(78.324);
            ...
            public static final Distance kAimOffset = Inches.of(25);
        }

        /* amp constants */
        public static final Distance kXToAmp = Inches.of(49.5);
        public static final Distance kYToAmp = Inches.of(286.765);
        public static final Distance kZToAmp = Inches.of(35);
    ...
    public class ShooterK {
        ...
        public static final AngularVelocity kAmpTolerance = RotationsPerSecond.of(1.25);
        public static final AngularVelocity kBigShootTolerance = RotationsPerSecond.of(2);
    ...
    public static class AimK {
        ...
        public static final Distance kLength = Inches.of(18);
        // asin((22 - kHeightTilShooter) / kLength)
        public static final Angle kStageClearance = Degrees.of(47.097);
        public static final Angle kMinAngle = Rotations.of(0);
        public static final Angle kInitAngle = Degrees.of(90);
        public static final Angle kMaxAngle = Rotations.of(0.45);

        public static final Angle kSubwooferAngle = Rotations.of(0.08);
        public static final Angle kAmpAngle = Rotations.of(0.195);
        public static final Angle kPodiumAngle = Degrees.of(6.5);
        public static final Angle kTrapAngle = Degrees.of(74.2);
        public static final Angle kClimbAngle = Degrees.of(60);
        public static final Angle kClimbingAngle = Degrees.of(50);
    ...
    public class RobotK {
        ...
        public static final Distance kHeightTilShooter = Inches.of(7.533);
