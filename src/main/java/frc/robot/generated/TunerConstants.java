...
public class TunerConstants {
	...
	// TODO check steer values
	// The steer motor uses any SwerveModule.SteerRequestType control request with
	// the output type specified by SwerveModuleConstants.SteerMotorClosedLoopOutput
	private static final Slot0Configs steerGains = new Slot0Configs()
		.withKP(57.69).withKI(0).withKD(0)
		.withKS(0.3626).withKV(2.218).withKA(0.35);
	// When using closed-loop control, the drive motor uses the control
	// output type specified by SwerveModuleConstants.DriveMotorClosedLoopOutput
	private static final Slot0Configs driveGains = new Slot0Configs()
		.withKP(0.0613105).withKI(0).withKD(0)
		.withKS(0.30349).withKV(0.1113125).withKA(0.012764575);
	...
	private static final double kFrontLeftEncoderOffset = -0.336181640625;
	...
	private static final double kFrontRightEncoderOffset = -0.295654296875;
	...
	private static final double kBackRightEncoderOffset = 0.051513671875;
